...
SOPCINFO_FILE := C:/altera/15.0/lab8ish_soc.sopcinfo
...
# Design Name 
# setting SOPC_NAME is lab8ish_soc
SOPC_NAME := lab8ish_soc
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x10001098
SOPC_SYSID_FLAG += --sidp=0x10001098
ELF_PATCH_FLAG  += --sidp 0x10001098

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1512712360
SOPC_SYSID_FLAG += --timestamp=1512712360
ELF_PATCH_FLAG  += --timestamp 1512712360
